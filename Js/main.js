...
//All Butonuna Tıklayınca Çalışır
function allBtn(){
  console.log("allgirdük")
  let div = " "
  for(var i in menu){ 
    div += template(menu[i])
  }
...
//Korea Butonuna Tıklayınca Çalışır
function koreaBtn(){
  console.log("korea girdük")
  let div = " "
  for(var i in menu){
...
//Japan Butonuna Tıklayınca Çalışır
function japanBtn(){
  console.log("japan girdük")
  let div = " "
  for(var i in menu){
...
//China Butonuna Tıklayınca Çalışır
function chinaBtn(){
  console.log("China girdük")
  let div = " "
  for(var i in menu){
